  ...
  <div style=" width: 70%; margin-left: 20%; ">
    ...
    <h1>Testimonials</h1>
      <hr>
        ...
        <a   class="btn btn-primary" href="addquiz.php">Add Question</a> 
    ...
    <table class="table table-bordered">
      ...
      $query=mysqli_query($conn,"select * from quiz_questions where instructor='$instructor' limit $page1,5");
       ...
       $query=mysqli_query($conn,"select * from quiz_questions where instructor='$instructor'");
