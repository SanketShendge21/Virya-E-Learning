  ...
  <div style=" width: 70%; margin-left: 20%; ">
    ...
    <table class="table table-bordered">
       <tr>
        ...
        $count=1;   
      $query=mysqli_query($conn,"select * from courses limit $page1,5");
      ...
      $query=mysqli_query($conn,"select * from lectures limit $page1,5");
       ...
       $query=mysqli_query($conn,"select * from lectures");
       $count=mysqli_num_rows($query);
       $a=$count/5;
        ceil($a);
        for ($b=1; $b<=$a ; $b++) { 
