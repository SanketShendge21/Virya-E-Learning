...
<div class="container">
    ...
    <div class="row mt-2 pb-3">
        ...
        $stmt = $conn->prepare("SELECT * FROM courses WHERE course_cat='computer_science'");
        $stmt->execute();
        ...
        <div class="col-sm-6 col-md-4 col-lg-3 mb-2">
            <div class="card-deck">
                ...
                <img src="<?php echo $row['course_image'] ?>" class="card-img-top" alt="Error Loading Image" width="245px" height="163px" onerror="this.onerror=null;this.src='../../Virya_Project/images/<?php echo $row['course_image'];?>';" >
